...
- как в современных чатах: `Enter` — поставить в очередь, `Ctrl+Enter` (Cmd+Enter) — отправить немедленно, не дожидаясь модели; у сообщения в очереди в чате есть кнопки «Отправить сейчас» и «Убрать».
