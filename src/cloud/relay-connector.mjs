...
export const CLOUD_ALLOWED = [
  ...
  { method: 'POST', path: '/api/tasks/:id/auto-compaction' },
  { method: 'GET', path: '/api/tasks/:id/state' },
  { method: 'GET', path: '/api/tasks/:id/approvals' },
  { method: 'POST', path: '/api/tasks/:id/approvals/:approvalId' },
